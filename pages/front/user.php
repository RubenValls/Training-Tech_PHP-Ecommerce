...
<body>
    <nav class="navbar bg-light">
        <div class="container-fluid">
            ...
            <a class="text-center text-dark text-decoration-none fw-semibold" href="cart.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="bi bi-cart-fill" viewBox="0 0 16 16" id="cartIcon">
